@echo off
REM
REM summary: Removes the OOTyW_en-GB software package.
REM 
...
REM 
REM Preconditions:
REM * OOTyW_en-GB is installed.
REM * OpenOffice.org 3.x or Apache OpenOffice 4.x is installed.
REM 
REM Postconditions:
REM * Previously auto-installed items of OOTyW_en-GB are removed.
...
echo -----------------------------------------------------------------
echo OOTyW_en-GB (OpenOffice typography tools for yWriter users) v%_release%
...
echo -----------------------------------------------------------------
echo #
echo # OOTyW_en-GB v%_release% is removed from your PC.
echo #
echo -----------------------------------------------------------------
pause
